	...
	return &testbackend.TestCase{
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0x1400035ce00)(name:"equation" type:STRING s:"ij->i" )
		   }
		   ,
		   },
		...
		*/
		...
		ExpectedOutput: []tensor.Tensor{
			...
			tensor.New(
				tensor.WithShape(3),
				tensor.WithBacking([]float64{5.383840737642084, 1.6890113195014478, 1.9056967282686674}),
			),
		},
	}
}
