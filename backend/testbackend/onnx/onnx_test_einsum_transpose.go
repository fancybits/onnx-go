...
func init() {
	testbackend.Register("Einsum", "TestEinsumTranspose", NewTestEinsumTranspose)
}

// NewTestEinsumTranspose version: 7.
func NewTestEinsumTranspose() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "Einsum",
		Title:  "TestEinsumTranspose",
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0x1400035d500)(name:"equation" type:STRING s:"ij->ji" )
		   }
		   ,
		   },
		...
		*/
		...
		ExpectedOutput: []tensor.Tensor{
			...
			tensor.New(
				...
				tensor.WithBacking([]float64{1.764052345967664, 1.8675579901499675, -0.10321885179355784, 0.4001572083672233, -0.977277879876411, 0.41059850193837233, 0.9787379841057392, 0.9500884175255894, 0.144043571160878, 2.240893199201458, -0.1513572082976979, 1.454273506962975}),
			),
		},
	}
}
