	...
	return &testbackend.TestCase{
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0x140002e9300)(name:"keepdims" type:INT i:1 )
		   }
		   ,
		   },
